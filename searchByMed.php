  ...
  text-align: left;
    ...
    <a style = "text-align:right" class="navbar-brand" href="Admin_Log_In.php">Admin Login</a>
		...
		<form name= "search" action = "searchByMed.php" method = "POST">
			...
			<h4 style = "text-align:center; color: gray">Search By Medicine </h4><br>
		</form>
		...
		// Create connection
			...
			$sql = "SELECT m.medicine_id, m.name as medicine, b.name as brand FROM medicine m JOIN brand b ON m.brand_id = b.brand_id WHERE m.name like '%$name%';";
